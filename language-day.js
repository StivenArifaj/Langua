...
const exhibits = {
  ...
  albanian: {
    ...
    traits: [['Artikulli i caktuar vjen pas emrit', 'Ndryshe nga anglishtja, shqipja shpesh e shpreh shquarsinë duke i bashkëngjitur nyjën e shquar në fund të emrit. Libër do të thotë “libër”; libri do të thotë “libri”.'], ['Dy grupe kryesore dialektesh', 'Gegërishtja flitet kryesisht në veri të lumit Shkumbin, kurse toskërishtja kryesisht në jug. Standardi bazohet kryesisht në toskërishten.'], ['Një sistem i pasur foljor', 'Foljet shqipe shprehin personin, numrin, kohën, mënyrën dhe diatezën. Shqipja ka gjithashtu një sistem të pasur foljor, me forma të ndryshme që përdoren sipas funksionit dhe kuptimit të shprehjes.'], ['Alfabet latin me 36 shkronja', 'Disa tinguj shënohen me dyshkronja si dh, gj, ll, nj, rr, sh, th, xh dhe zh. Këto dyshkronja konsiderohen shkronja më vete.']],
