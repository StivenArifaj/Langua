...
const exhibits = {
  english: {
    ...
    intro: 'A Germanic island language that learned to travel: first through conquest, then print, trade, science, migration, and the internet.',
    ...
    phrase: 'How do you do?', phonetic: '/haʊ duː juː duː/', meaning: 'Originally a polite greeting, not a question asking for information. The answer can simply repeat the phrase.',
  ...
  french: {
    ...
    intro: 'Le français est né du latin quotidien du nord de la Gaule, puis est devenu une langue de littérature, de diplomatie, de droit, de migration et d’échanges internationaux.',
    ...
    history: [['842', 'Les Serments de Strasbourg', 'L’un des premiers textes survivants dans une variété romane distincte du latin.'], ['1539', 'L’ordonnance de Villers-Cotterêts', 'Le roi François Ier imposa le français au lieu du latin dans de nombreux documents juridiques.'], ['1635', 'L’Académie française', 'Fondée pour travailler sur la langue française et son dictionnaire ; son rôle reste surtout consultatif.'], ['19e–20e siècle', 'École et standardisation', 'L’école nationale a accéléré l’usage du français standard avec les langues régionales.'], ['aujourd’hui', 'Une langue à plusieurs centres', 'Le français est façonné par les locuteurs de France et d’autres pays, chacun avec son propre vocabulaire et son accent.']],
  ...
  german: {
    ...
    lineage: [['ca. 4500–2500 v. Chr.', 'Proto-Indoeuropäisch', 'Die rekonstruierte gemeinsame Wurzel vieler Sprachen in Europa und Teilen Asiens.'], ['ca. 500 v. Chr.', 'Urgermanisch', 'Die gemeinsame Vorstufe von Deutsch, Englisch, Niederländisch und den skandinavischen Sprachen.'], ['ca. 750–1050', 'Althochdeutsch', 'Eine Gruppe süddeutscher Dialekte, in religiösen und rechtlichen Texten überliefert.'], ['heute', 'Deutsch', 'Eine Standardsprache mit starken regionalen Varianten in Mitteleuropa.']],
    history: [['ca. 750–1050', 'Althochdeutsch', 'Die hochdeutsche Lautverschiebung trennte die südlichen Varietäten deutlich von Englisch und Niederländisch.'], ['1522–1534', 'Luthers Bibel', 'Martin Luthers Übersetzung benutzte eine ostmitteldeutsche Schriftsprache, die sehr einflussreich wurde.'], ['18.–19. Jh.', 'Ein literarischer Standard', 'Schriftsteller, Schulen und Druckkultur stabilisierten die Standardsprache, während Dialekte weiterlebten.'], ['1901', 'Orthographische Konferenz', 'Eine Konferenz in Berlin festigte eine gemeinsame Rechtschreibung für deutschsprachige Länder.'], ['heute', 'Eine Sprache der Regionen', 'Die Standardsprache koexistiert mit Dialekten und eng verwandten Varietäten in Deutschland, Österreich, der Schweiz und darüber hinaus.']],
    words: [['ein Wort aus Teilen', 'Handschuh', 'Wörtlich „Handschuh“: ein Handschuh. Deutsche Zusammensetzungen schaffen oft klare, einprägsame Begriffe.'], ['ein grammatischer Hinweis', 'Fernweh', '„Fernweh“ bedeutet die Sehnsucht, weit weg zu sein; ein modernes Kompositum nach dem Muster von Heimweh.'], ['Klang und Schrift', 'ich', 'Das ch verändert sich je nach Kontext: Nach vorderen Vokalen klingt es meist weicher wie [ç].']],
  ...
  albanian: {
    ...
    intro: 'Shqipja është një degë e veçantë e indo-evropiane: jo një gjuhë romake, sllave ose greke, por një dëshmi e thellë e historisë gjuhësore të Ballkanit.',
    lineage: [['rreth 4500–2500 p.e.s.', 'Proto-indoevropiane', 'Burimi i rindërtuar i shqipes dhe shumë degëve të tjera indo-evropiane.'], ['antikiteti', 'Shqipja e hershme', 'Prehistoria e saj është e debatuar, por shqipja u zhvillua në mënyrë të pavarur në Ballkanin perëndimor.'], ['1462', 'Fjalia e parë e njohur', 'Një formulë pagëzimi e shkruar nga peshkopi Pal Engjëlli është teksti më i hershëm i njohur shqip.'], ['sot', 'Shqip', 'Një gjuhë me dy grupe kryesore dialektesh, gegërisht dhe toskërisht, me standard bazuar kryesisht në toskërishten.']],
    history: [['1462', 'Fillimi i shkrimit', 'Formula e pagëzimit e Pal Engjellit ruan fjalinë më të hershme të njohur shqipe.'], ['1555', 'Meshari', 'Missali i Gjon Buzukut është libri i parë i njohur i shtypur në shqip.'], ['1908', 'Kongresi i Manastirit', 'Delegatët miratuan një alfabet latin, duke zbutur konkurrencën mes disa sistemesh shkrimi.'], ['1972', 'Kongresi i drejtshkrimit', 'U konsolidoj një sistem standard i drejtshkrimit, i bazuar kryesisht në formën toskëre.'], ['sot', 'Një gjuhë ndër kufij', 'Shqipja flitet në Shqipëri, Kosovë, vende fqinjë dhe në komunitete të gjera të diasporës.']],
    ...
    traits: [['Artikulli i caktuar vjen pas emrit', 'Ndryshe nga anglishtja, shqipja shpesh e bashkëngjitur caktimin në fund të emrit. Libër do të thotë “libër”; libri do të thotë “libri”.'], ['Dy grupe kryesore dialektesh', 'Gegërishtja flitet kryesisht në veri të lumit Shkumbin, kurse toskërishtja kryesisht në jug. Standarti bazohet kryesisht në toskërishten.'], ['Një sistem i pasur foljor', 'Foljet shqipe shprehin personin, numrin, kohën, mënyrën dhe zhanrin. Nënshartesa është veçanërisht e shpeshtë në shprehjet e përditshme.'], ['Alfabet latin me 36 shkronja', 'Disa tinguj shënohen me dyshkrone si dh, gj, ll, nj, rr, sh, th, xh dhe zh. Këto dyshkronja numërohen si shkronja të veçanta.']],
    culture: { title: 'Një gjuhë që mban një kujtesë të gjerë ballkanike.', text: ['Shkrimi shqip u rrit përmes librave fetarë, folklorit, poezisë dhe veprës së Rilindjes Kombëtare në shekullin XIX. Letërsia moderne mbart kujtime nga jeta e fshatit, qytetet, migrimet dhe ndryshimet politike.', 'Pasi shqipja flitet nëpër kufij kombëtarë dhe në një diasporë të madhe, ajo vazhdimisht përshtatet. Ky nuk është një rrezik për gjuhën; është prova se shqipja mbetet një mënyrë e gjallë dhe e ndarë e kuptimit.'], quote: '“Gjuha ruhet atje ku flitet me dashuri.” — një parim i thjeshtë shqip: gjuha ruhet atje ku flitet me kujdes.' },
    phrase: 'Mirë se vini!', phonetic: '/mi.ɾə sɛ ˈvi.ni/', meaning: '“Mirë se vini.” Shqipja ka një sistem të pasur të përemrave dhe fundjave të caktuara: artikulli zakonisht bashkëngjitet në fund të emrit.',
...
const ui = {
  ...
  german: {
    ...
    sectionIntro: ['Sprachen sind keine eingefrorenen Gegenstände. Diese Spur zeigt die Sprache durch ihre Verwandtschaftsbeziehungen und die geschichtlichen Stufen, die ihre Struktur heute erklären.', 'Kriege, Bücher, Schulen, Städte und Migration verändern alles, was Menschen sagen, schreiben und hören.', 'Ein einziges Wort kann eine Handelsroute, eine Lautveränderung, eine gesellschaftliche Gewohnheit oder ein jahrhundertealtes Zusammentreffen bewahren.', 'Grammatik ist keine Ansammlung von Hindernissen. Sie ist das Muster, mit dem Sprecher Betonung, Beziehungen, Zeit und Zugehörigkeit ausdrücken.', 'Hören Sie auf Rhythmus und Klänge, die die Rechtschreibung darstellt. Jede Sprache bildet ihre eigenen Muster aus Betonung, Vokalen und Konsonanten.', ''],
  ...
  italian: {
    ...
    nav: ['Radici', 'Storia', 'Parole', 'Caratteri', 'Suono', 'Cultura'],
    country: 'Focus paese',
    code: 'Codice lingua',
  ...
  albanian: {
    ...
    country: 'Fokus vendi',
    code: 'Kodi i gjuhës',
    explore: 'Rrëshqit për të eksploruar',
    begin: 'Fillo',
    ...
    made: 'E bërë për Langua.',
    imageAlt: 'Një foto e vërtetë nga',
    historyLabel: 'Një skenë historike e vërtetë nga',
    cultureLabel: 'Një pamje e vërtetë e',
    hearLabel: 'Dëgjo',
