...
const exhibits = {
  ...
  albanian: {
    ...
    lineage: [['rreth 4500–2500 p.e.s.', 'Proto-indoevropiane', 'Burimi i rindërtuar i shqipes dhe shumë degëve të tjera indo-evropiane.'], ['antikiteti', 'Shqipja e hershme', 'Prehistoria e saj është e debatuar, por shqipja u zhvillua në mënyrë të pavarur në Ballkanin perëndimor.'], ['1462', 'Fjalia e parë e njohur', 'Një formulë pagëzimi e shkruar nga peshkopi Pal Engjëlli është teksti më i hershëm i njohur shqip.'], ['sot', 'Shqip', 'Një gjuhë me dy dialekte kryesore, gegërishten dhe toskërishten, me një standard të bazuar kryesisht në toskërishten.']],
    history: [['1462', 'Fillimi i shkrimit', 'Formula e pagëzimit e Pal Engjëllit ruan fjalinë më të hershme të njohur në shqip.'], ['1555', 'Meshari', 'Meshari i Gjon Buzukut është libri i parë i njohur i shtypur në shqip.'], ['1908', 'Kongresi i Manastirit', 'Delegatët miratuan një alfabet latin, duke unifikuar përdorimin e alfabetit latin.'], ['1972', 'Kongresi i drejtshkrimit', 'Në 1972 u miratuan dhe u konsoliduan rregullat e drejtshkrimit standard të shqipes.'], ['sot', 'Një gjuhë ndër kufij', 'Shqipja flitet në Shqipëri, Kosovë, vende fqinjë dhe në komunitete të gjera të diasporës.']],
    words: [['një mirëseardhje e gjallë', 'mirë se vini', 'Përkthim i drejtpërdrejtë: “mirë se vijnë”, një mirëseardhje e përdorur për mysafirë ose në formë zyrtare.'], ['një shkronjë, një tingull', 'shqip', 'sh është /ʃ/, ndërsa q është një tingull palatal ndalues. Alfabeti latin ka 36 shkronja.'], ['një dëshmi e Ballkanit', 'besë', 'Shpesh përkthehet si “betim i nderit”, por kuptimi kulturor është më i gjerë dhe varet nga konteksti.']],
    traits: [['Artikulli i caktuar vjen pas emrit', 'Ndryshe nga anglishtja, shqipja shpesh e shpreh shquarsinë duke i bashkëngjitur nyjën e shquar në fund të emrit. Libër do të thotë “libër”; libri do të thotë “libri”.'], ['Dy dialekte kryesore', 'Gegërishtja flitet kryesisht në veri të zonës së Shkumbinit, ndërsa toskërishtja kryesisht në jug, me zona kalimtare midis tyre. Standardi bazohet kryesisht në toskërishten.'], ['Një sistem i pasur foljor', 'Foljet shqipe shprehin personin, numrin, kohën, mënyrën dhe diatezën. Shqipja ka gjithashtu një sistem të pasur foljor, me forma të ndryshme që përdoren sipas funksionit dhe kuptimit të shprehjes.'], ['Alfabet latin me 36 shkronja', 'Disa tinguj shënohen me dyshkronja si dh, gj, ll, nj, rr, sh, th, xh dhe zh. Këto dyshkronja konsiderohen shkronja më vete.']],
    ...
    phrase: 'Mirë se vini!', phonetic: '/mi.ɾə sɛ ˈvi.ni/', meaning: '“Mirë se vini.” Shqipja ka një sistem të pasur gramatikor; një nga veçoritë e saj është se nyja e shquar zakonisht i bashkëngjitet emrit në fund.',
...
const ui = {
  ...
  french: {
    ...
    sectionHeadings: ['D’où elle vient.', 'L’histoire laisse une grammaire.', 'Le vocabulaire est une carte des contacts.', 'Sa propre manière de construire le sens.', 'Un salut en gros plan.', ''],
  ...
  german: {
    ...
    country: 'Landesfokus',
    code: 'Sprachcode',
    explore: 'Zum Entdecken scrollen',
    begin: 'Starten',
    ...
    sectionHeadings: ['Woher sie stammt.', 'Geschichte hinterlässt Grammatik.', 'Wortschatz ist eine Karte der Kontakte.', 'Ihre eigene Art, Bedeutung zu vermitteln.', 'Ein Gruß aus nächster Nähe.', ''],
    ...
    cultureLabel: 'Eine echte Ansicht von',
  ...
  italian: {
    ...
    begin: 'Inizia',
    sectionPrefix: ['01 / Famiglia linguistica', '02 / Una lingua nel tempo', '03 / Parole piccole, grandi viaggi', '04 / Come funziona la lingua', '05 / Ascolta i suoi suoni', '06 / Letteratura, memoria, identità'],
    sectionHeadings: ['Da dove viene.', 'La storia lascia il segno nella grammatica.', 'Il lessico è una mappa dei contatti.', 'Il suo modo di costruire il significato.', 'Un saluto da vicino.', ''],
    ...
    imageAlt: 'Una vera fotografia di',
    historyLabel: 'Una vera scena storica di',
  ...
  albanian: {
    ...
    sectionIntro: ['Kjo linjë e ndjek zhvillimin e gjuhës përmes marrëdhënieve familjare dhe etapave historike që shpjegojnë strukturën e saj sot.', 'Luftërat, librat, shkollat, qytetet dhe migrimet ndryshojnë gjithçka që njerëzit thonë, shkruajnë dhe dëgjojnë.', 'Një fjalë e vetme mund të ruajë një rrugë tregtie, një ndryshim tingulli, një zakon shoqëror ose një takim të ndodhur shekuj më parë.', 'Gramatika nuk është një koleksion pengesash. Është modeli që përdorin folësit për të treguar theksin, marrëdhëniet, kohën dhe përkatësinë.', 'Dëgjoni ritmin dhe tingujt që pasqyron drejtshkrimi. Çdo gjuhë ka modelet e veta të theksit, zanoreve dhe bashkëtingëlloreve.', ''],
    hear: 'Dëgjo frazën',
    back: 'Kthehu lart ↑',
